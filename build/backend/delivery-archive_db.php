...
class Database extends Config
{
  ...
  public function getArchiveItem($archiveId) {
    $sql = 'SELEcT * FROM delivery_archive WHERE id = :id';
    $stmt = $this->conn->prepare($sql);
  ...
  public function archiveRecord($user_id, $origin, $key, $value)
  {
    ...
    $sqlArchive = "INSERT iNTO delivery_archive (user_id, origin_table, data) VALUES (:user_id, :origin, :data)";
  ...
  public function recoverRecord($id)
  {
    ...
    $sqlFetch = "SELECT * FROM delivery_archive WHERE id = :id";
    $stmtFetch = $this->conn->prepare($sqlFetch);
    ...
    $sqlDelete = "DELETE FROM delivery_archive WHERE id = :id";
    $stmtDelete = $this->conn->prepare($sqlDelete);
  ...
  public function readAll($user_id, $start, $limit, $column, $order, $query, $origin)
  {
    ...
    $sql = "SELECT * FROM delivery_archive
  ...
  public function getTotalRows($query, $origin)
  {
    ...
    $sql = "SELECT COUNT(*) as total FROM delivery_archive
  ...
  public function deleteRecord($id) {
    $sql = 'DELETE from delivery_archive WHERE id = :id ';
    $stmt = $this->conn->prepare($sql);
    $stmt->execute([
      'id' => $id,
    ]);
