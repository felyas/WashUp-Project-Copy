    ...
    <div class="bg-white rounded-sm shadow-lg p-6 w-full max-w-lg">
      ...
      <form id="editForm" class="mt-4">
        ...
        <div class=" mb-4">
          ...
          <input type="text" id="service" name="service" class="mt-1 block w-full border-gray-300 rounded-sm py-2 px-2 border border-solid border-ashblack" placeholder=" Service Choosen: ">
        </div>
        <div class=" mb-4">
