          ...
          <div class="flex items-center justify-between  lg:space-x-4 text-sm">
            ...
            <div class="flex items-center justify-between">
              <div class="relative">
                ...
                <div class="js-notification hidden h-auto w-96 z-10 absolute top-[52px] -right-[68px] text-nowrap border border-gray-200 border-solid bg-white flex flex-col items-center shadow-lg text-ashblack">
